...
Submit the job using [`qq submit`](commands/qq_submit.md):
...
After submission, you can inspect the job using [`qq info`](commands/qq_info.md), access its working directory on the compute node with [`qq go`](commands/qq_go.md), or terminate it using [`qq kill`](commands/qq_kill.md). For an overview of all qq commands, see [this section](commands/commands.md) of the manual.
